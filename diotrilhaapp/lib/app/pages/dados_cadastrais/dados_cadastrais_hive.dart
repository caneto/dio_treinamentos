...
import 'package:trilhaapp/app/repositories/dados_cadastrais_repository.dart';
...
class _DadosCadastraisHivePageState extends State<DadosCadastraisHivePage> {
  ...
  carregarDados() async {
    ...
    if (dataNacimentoController.text.isEmpty) {
      dataNacimentoController.text = dateFormat.format(dadosCadastraisModel.dataNascimento!);
    }
    setState(() {});
  }
                ...
                children: [
                  ...
                  TextField(
                      ...
                      onTap: () async {
                        ...
                        if (data != null) {
                          dataNacimentoController.text = dateFormat.format(data);
