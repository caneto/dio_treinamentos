...
class TextStyles {
  ...
  TextStyle get textTextButtonLabel => textBold.copyWith(fontSize: 15);

  TextStyle get textTitle => textBold.copyWith(fontSize: 28);
  
  TextStyle get dashboardTextStyle => TextStyle(
      color: Colors.blue, fontSize: 25.sp, fontWeight: FontWeight.bold);

  TextStyle get dashboardBottomText => TextStyle(
    fontSize: 14.sp,
    color: ColorsApp.i.dashboardColor,
  );
}
