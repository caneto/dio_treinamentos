...
class ConfiguracoesSheredPreferencePage extends StatefulWidget {
  const ConfiguracoesSheredPreferencePage({Key? key}) : super(key: key);

  @override
  State<ConfiguracoesSheredPreferencePage> createState() => _ConfiguracoesSheredPreferencePageState();
}

class _ConfiguracoesSheredPreferencePageState extends State<ConfiguracoesSheredPreferencePage> {
